            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" id="headingOne">
                        <h5 class="mb-0">
                            Editar perfil: <i>{{$usuario->name}}</i>
                        </h5>
                    </div>

                    <form class="form-horizontal" action="{{(route('admin.usuarios.update', ['id' => $usuario->id]))}}" method="post">
                        @if(isset($usuario))
                ...
                <div id="accordion">
                    ...
                    @if((empty($usuario->type_id) || $usuario->tipo->is_admin == 1) || $usuario->type_id == $tipo->id)
                    <div class="card">
                        <div class="card-header" id="headingOne">
                            <h5 class="mb-0">
